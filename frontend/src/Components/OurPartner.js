...
function OurPartner() {
    ...
    return (
        ...
        <div class="logo-display-sec2" style={{width:"100%"}}>
            ...
            <section style={{ background: '#F8F8F8', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', marginTop: '4rem', padding: "5% 0" }}>
                <div style={{ width: "90%" }}>
                    <div className='filterTopSec' style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', columnGap: "2rem", rowGap: '1rem' }}>
                        <div style={{ width: '48%' }}>Westford takes pride in its partnerships with reputed universities from the UK , USA , Italy, Spain, Cyprus, Malaysia and awarding organizations from the UK.</div>
                        <div className='filterBtns' style={{ width: '48%', background: 'white', display: 'flex', alignItems: 'center', }}>
                            <span style={{background:btnColour==='fiterCard'?'#285F71':"",color:btnColour==='fiterCard'?'white':""}} data-filter='fiterCard' className='filterall filter'>All</span>
                            <span style={{background:btnColour==='America'?'#285F71':"",color:btnColour==='America'?'white':""}} data-filter='America' className='filteramerica filter'>America</span>
                            <span style={{background:btnColour==='Europe'?'#285F71':"",color:btnColour==='Europe'?'white':""}} data-filter='Europe' className='filtereurope filter'>Europe</span>
                            <span style={{background:btnColour==='Spain'?'#285F71':"",color:btnColour==='Spain'?'white':""}} data-filter='Spain' className='filterspain filter'>Spain</span>
                        </div>
                ...
                <div className='filterCards'>
                    <div className='fiterCard America'>
                        <img src={dummyLogo} alt="" />
                        <p style={{ marginBottom: "0" }}>(A)Council For Higher Education Accreditation (CHEA)</p>
                    </div>
                    <div className='fiterCard America'>
                        <img src={dummyLogo} alt="" />
                        <p style={{ marginBottom: "0" }}>(A)Council For Higher Education Accreditation (CHEA)</p>
