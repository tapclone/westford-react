          ...
          >
            <div
              style={{
                ...
                borderRadius: "20px",
                background:
                  "linear-gradient(360deg, #1F1F1F 0%, rgba(31, 31, 31, 0) 85.5%)",
              }}
            >
              <img
                style={{
            ...
            <div
              className="mediaCentreTop2"
              style={{ width: "40%", height: "100%" }}
            >
              <h1>
                Why DBA’s from European Universities are higher in demand in
                Africa?
              </h1>
              <p>
                When a crisis happens and times are tough it can be easy to lose
                focus on the importance of supporting and growing a strong{" "}
              </p>
              <button
                style={{
                  padding: "5px 10px ",
                ...
                onclick="window.location.href='/westfordeducation/article-one.html';"
              >
                Read More
              </button>
            </div>
            ...
            >
              ...
              >
                <h3 style={{ fontWeight: "normal" }}>
                  Why DBA’s from European Universities are higher in...
                </h3>
                <p>
                  When a crisis happens and times are tough it can be easy to
                  lose focus on the importance...
                </p>
