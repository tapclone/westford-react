        ...
        <div class="header">
            <div class="topbar">
                ...
                <a onClick={()=>navigate('/contact')}>
                    <button class="top-btn contactUs"
                ...
                <img onClick={()=>setNavState(!navState)} class="menu-icon" src={menuIcon} alt="Navigation menu button" />
            </div>
            ...
            <div class="navbar" style={{height:navState&&'15rem'}}>
                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item"><a onClick={()=>navigate('/about')}>About Us</a></li>
                    <li class="nav-item"><a onClick={()=>navigate('/ourInstitution')}>Our Institutions</a></li>
                    <li class="nav-item"><a onClick={()=>navigate('/ourPartners')}>Our Partners</a></li>
                    <li class="nav-item"><a onClick={()=>navigate('/awards')}>Awards & Accolades</a></li>
                    <li class="nav-item"><a onClick={()=>navigate('/mediaCentre')}>Media Centre</a></li>
                </ul>
