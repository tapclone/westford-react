...
function About() {
    ...
    function CustomArrowR(props) {
        ...
        return (
            <div className={className} style={{ ...style, display: "block" }} onClick={onClick}>
                <img className="slideBtn" style={{ width: "2rem" }} src={downBtn} alt="" />
            </div>
        );
    }
    ...
    function CustomArrowL(props) {
        ...
        return (
            <div className={className} style={{ ...style, display: "block" }} onClick={onClick}>
                <img className="slideBtn" style={{ width: "2rem" }} src={upBtn} alt="" />
            </div>
        );
    }
        ...
        <div style={{ width: "100%", overflowX: "hidden" }}>
                ...
                <div className="startingContentContainer" style={{ width: "90%", display: "flex" }}>
                    ...
                    >
                        <div style={{ width: "93%" }}>
                            ...
                            >
                                Westford Education Group (WEG) operating as Westford Ventures Holding Ltd., A ADGM
                                registered company with multiple brands of higher education programs through its campuses
                                and satellite learning centres all across the globe. The group is established with an
                                objective to fulfil the aspirations of learners with diverse backgrounds from across the
                                globe to attain internationally-accredited qualifications in the form of on-site and online
                            ...
                            >
                                Working toward a world where everyone has access to higher education, WEG now stands out
                                winning the confidence of its learners and the community, a result of its steadfast
                                commitment to students’ welfare and their success stories.{" "}
                            </p>
                            <p
                                style={{
                                    textAlign: "justify",
                            ...
                            >
                                {" "}
                                At Westford, we have come up with an integrated strategy and operational model for the
                                global education. The group’s overall mission is “enabling the student of today to become a
                                successful individual of tomorrow”.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            return (
                                <div>
                                    ...
                                    >
                                        ...
                                        >
                                            <h2 style={{ fontSize: "2.3rem", color: "white" }}>{item.year}</h2>
                                        </div>
            ...
            >
                ...
                >
                    ...
                    <ul className="missionPoints" style={{ margin: "0" }}>
                        <li style={{ lineHeight: "1.6" }}>
                            To be an unwavering flag-bearer in providing accredited qualifications delivered in a flexible,
                            accessible, and affordable manner to the largest international network of learners.
                        </li>
                        <li style={{ lineHeight: "1.6" }}>
                            To ensure access to quality higher education for learners across the globe.
                        </li>
                        <li style={{ lineHeight: "1.6" }}>
                            To foster the development of talent while simultaneously empowering the modern workforce through
                            continued education{" "}
                        </li>
                        <li style={{ lineHeight: "1.6" }}>
                            To pave the way for a better world by transforming the lives of individuals.
                        </li>
                    </ul>
                </div>
                <div
                ...
                >
                    ...
                    <p style={{ color: "white", lineHeight: "1.6", textAlign: "justify" }}>
                        The focal point of all our endeavours is the ‘student experience’. Today, our world-class education
                        ...
                        work-world-based approach.
                    </p>
                </div>
            </section>

            <div class="our-leaders" style={{ height: "fit-content", paddingBottom: "15%" }}>
                <div class="leadership-headings" style={{ width: "60%" }}>
                    ...
                    <p style={{ width: "100%", marginBottom: "3.5rem" }}>
                        Our team of eminent professionals from the academia and industry, possessing decades of experience
                        and knowledge contributes their expertise to build a high performing business which embodies
