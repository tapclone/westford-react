...
function About() {
    ...
    return (
        <div style={{ width: '100%', overflowX: 'hidden' }}>
            ...
            <section className='mileStoneSlider' style={{display:'flex',alignItems:'center',justifyContent:'center',marginTop:"5%",background:'#F8F8F8',padding:"5% 0",position:'relative'}}>
                    ...
                    <Slider {...settings4}>
                        {arr.map((item,index)=>{
                           return <div>
                            ...
                            <div style={{transform: `scale(${index === currentSlide ? 1 : 0.7})`}}  className='milStoneSliderSingle'>
                                <div className='overlaySmallSlider' style={{background:`${index!=currentSlide?'linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, rgba(255, 255, 255, 0) 0.01%, #F8F8F8 110%)':'transparent'}`}}></div>
                                <div className='milStoneSliderSingleSub1' style={{width:'30%',background:'#DB3656',display:'flex',alignItems:'center',justifyContent:'center'}}>
                                    <h2 style={{fontSize:'2.3rem',color:'white'}}>2000</h2>
                                </div>
                                <div className='milStoneSliderSingleSub2' style={{width:'70%',display:"flex",alignItems:'center',justifyContent:'center'}}>
                                    <div >
                                        <img src={trophy} alt="" />
                                        <span style={{fontSize:'2rem',color:'#303030',opacity:"0.3"}}>0{item}</span>
                                        <p>Rechristened westford school of management as westford university college and expanded its portfolio of partners. Programs and qualification</p>
                                    </div>
                                </div>
                            </div>
                            </div>
