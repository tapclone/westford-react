...
function Awards() {
    return (
        <div style={{ width: '100%', overflowX: 'hidden' }}>
            ...
            <div class="abt-westford aos" data-aos="zoom-in" data-aos-duration="1500" style={{ height: 'fit-content' ,paddingBottom:'3rem'}}>
                    ...
                    <div className='startingContentContainer' style={{ width: '90%', display: 'flex' }}>
                        <div className='startingContentImg' style={{ width: '40%', aspectRatio: "1/1", position: 'relative', minWidth: '25rem' }}>
                            ...
                            <div className='borderLayer' style={{ width: '90%', aspectRatio: '1/1', border: '3px solid #285F71', borderRadius: "10%", position: 'absolute' }}>
                                <img className='heroImgStartingSec' style={{width:'70%',top:"57.5%"}} src={heroImg} alt="" />
                            </div>
            ...
            <div class="all-trophies" style={{ height: 'fit-content' }}>
                ...
                <div class="all-trophy-heading" style={{width:'80%'}}>
                    <p style={{fontWeight:"600",fontSize:"16px"}}>Westford education group entities bagged many awards and recognition in past years as an evidence of
                ...
                <div class="trophy-display" style={{ width: '100%', height: 'fit-content' ,justifyContent:'center',alignItems:'center',overflowX:'hidden',paddingBottom:'3rem'}}>
                    <div class="trophy-display-row" style={{ flexWrap: 'wrap', height: 'fit-content', rowGap: '1rem', alignItems: 'center', justifyContent: 'space-between', columnGap: '0.5rem',width:'90%' }}>
