...
function Home() {
    ...
    useEffect(() => {
        (async function () {
            try {
                const { data } = await axios.get("/api/admin/view-all-own-universities");
        ...
        <div className="homeSection" style={{ width: "100%", overflowX: "hidden" }}>
            <Slider {...settingsBanner}>
                <div>
                    ...
                    >
                        <div className="hero-banner-slider" style={{ width: "100%", height: "100%" }}>
                            <div>
                ...
                >
                    ...
                    >
                        ...
                        <p style={{ margin: "0", padding: "0", lineHeight: "2" }}>
                            Westford provides academic degrees, diploma courses and professional certification in
                            partnership with accredited awarding organization and universities of international repute.
                        </p>
                    </div>
                </div>
                <div
                    ...
                    <div class="whorv-right-box">
                        <div class="right-box-text">
                            ...
                            <p>
                                Westford provides academic degrees, diploma courses and professional certification in
                                partnership with accredited awarding organization and universities of international repute.
                                We teach programs ranging from undergraduate to postgraduate levels. Graduate and Masters
                                Programs including MBA and BA Honors in Business, Higher National diplomas, professional
                                certificate courses specific to domains and industries are some of the courses we offer. We
                                also focus on UG and PG courses in media and broadcasting, filmmaking, animation and gaming
                                through our media school WIFT.{" "}
                            </p>
                        </div>
                ...
                >
                    <div class="wwsgm-right">
                        ...
                        <p class="aos" data-aos-duration="1000">
                            Our educational community boasts a global reach, with students from every part of the world.
                    ...
                    <div className="globeDiv" style={{ width: "60%" }}>
                        ...
                        >
                            <div className="asiaComp comps" data-aos="zoom-in-right" data-aos-duration="1000">
                                <p>ASIA</p>
                                <span>20%</span>
                            </div>
                            <div className="restComp1 comps" data-aos="zoom-in-up" data-aos-duration="1000">
                                <p>
                                    REST OF <br /> THE WORLD
                                </p>
                                <span>28%</span>
                            </div>
                            <div className="restComp2 comps" data-aos="zoom-in-up" data-aos-duration="1000">
                                <p>
                                    ASIA <br /> PACIFIC
                                </p>
                                <span>23%</span>
                            </div>
                            <div className="africaComp comps" data-aos="zoom-in-left" data-aos-duration="1000">
                                <p>
        ...
        <p>40%</p>
            ...
            <section class="corp-training" style={{ background: `url(${corp})`, height: "fit-content" }}>
                <div class="overlay" style={{ height: "fit-content", padding: "1rem 0" }}>
                    ...
                    <p>
                        Westford has an important presence in the corporate training circuit through our open enrollment
                        programs, <br />
            ...
            >
                <div class="customer-media-txt">
                    <h2 style={{ fontSize: "clamp(1.5rem,4vw,2.5rem)" }}>News And Events</h2>
                                        ...
                                        <div>
                                            <div className="reviewCard">
                                                ...
                                                >
                                                    ...
                                                    <h3 style={{ fontSize: "1.2rem", fontWeight: "600" }}>{header}...</h3>
                                                    <p>
                                                        {" "}
                                                        <img
                                                            className="media"
            ...
            <section class="corporate-clients" style={{ height: "fit-content", paddingBottom: "5rem" }}>
                <div class="corporate-client-txt">
                    <h2>Corporate Clients</h2>
                    <p>Our client base includes a wide range of corporations, small businesses and government agencies</p>
                </div>
                ...
                <div class="corp-client-logos" style={{ width: "98%" }}>
                    {CorporateClinets.map((items, index) => {
                        ...
                        return (
                            <>
                                <div class={empty ? "cc-logo-empty" : "cc-logo aos"} data-aos="flip-left">
                                    {empty ? (
                                        <>
                                            {" "}
                                            <img src="" alt="" />
